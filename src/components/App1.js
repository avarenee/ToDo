  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        {this.state.name !== undefined ? <Text>{this.state.welcomeText}</Text> : this.state.currentUserId !== undefined ? nameInput : <Text></Text>}
        {(this.state.name == undefined) && (this.state.tempName !== undefined) ? confirmNameButton : <Text></Text> }
      </View>
    );
  }
